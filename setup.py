...
ext_modules = [
    Extension(
        "interfacebuilder.backend", sources=["interfacebuilder/backend/backend.cpp"]
    )
]

setup(
    name="2D-interface-builder",
    version=version,
    author="Roman Kempt",
    author_email="roman.kempt@tu-dresden.de",
    description="A tool to generate 2D interfaces based on coincidence lattice theory.",
